...
1. Plug the GoPro into the computer via USB-C
2. Power it on

That's it. No battery required — the camera runs entirely off USB power. No WiFi, Bluetooth, or in-camera menu configuration is needed.
